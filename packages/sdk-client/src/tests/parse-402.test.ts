...
describe("parse402Response", () => {
  ...
  it("throws Parse402Error when error field missing", () => {
    expect(() => parse402Response({ requirements: VALID_BODY.requirements } as any)).toThrow(Parse402Error)
  })
  ...
  it("throws Parse402Error when requirements missing", () => {
    expect(() => parse402Response({ error: "payment_required" } as any)).toThrow(Parse402Error)
  })
