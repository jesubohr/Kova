...
describe("buildPaymentRequired", () => {
  it("returns correct 402 body with USDC testnet defaults", () => {
    ...
    expect(body.requirements.asset.contractId).toBe("CBIELTK6YBZJU5UP2WWQEUCYKLPU6AUNZ2BQ4WWFEIE3USCIHMXQDAMA")
  })
  ...
  it("uses mainnet USDC for mainnet network", () => {
    ...
    expect(body.requirements.asset.contractId).toBe("CCW67TSZV3SSS2HXMBQ5JFGCKJNXKZM7UQUWUZPUTHXSTZLEO7SJMI75")
  })
})
